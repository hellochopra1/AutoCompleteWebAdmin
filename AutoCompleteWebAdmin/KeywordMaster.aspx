<%@ Page Title="" Language="C#" MasterPageFile="~/DashBoard.Master" AutoEventWireup="true" EnableEventValidation="false" CodeBehind="KeywordMaster.aspx.cs" Inherits="AutoCompleteWebAdmin.KeywordMaster" %>
...
<asp:Content ID="Content3" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <telerik:RadScriptBlock ID="radscript1" runat="server">
        <script>
            ...
            function GetCount() {
                AutoCompleteOMST.GetTotalCountForKeywords(false, GetTotalCount);
            }
    ...
    <telerik:RadGrid ID="radGridKeyword" AutoGenerateColumns="false" AllowPaging="true" OnUpdateCommand="radGridKeyword_UpdateCommand"
        OnDeleteCommand="radGridKeyword_DeleteCommand" EnableHeaderContextMenu="true" AllowFilteringByColumn="true" ShowGroupPanel="true" AllowMultiRowSelection="true" OnInsertCommand="radGridKeyword_InsertCommand" AllowSorting="true" PageSize="10" OnNeedDataSource="radGridKeyword_NeedDataSource" OnItemDataBound="radGridKeyword_ItemDataBound" runat="server">
        ...
        <ClientSettings AllowDragToGroup="True" ColumnsReorderMethod="Reorder" AllowColumnsReorder="True" ReorderColumnsOnClient="True">
            ...
            <Resizing AllowColumnResize="True" AllowResizeToFit="True" ResizeGridOnColumnResize="True"
                AllowRowResize="true" ClipCellContentOnResize="true" EnableRealTimeResize="true" />
