...
{
    public partial class KeywordMaster : Telerik.Web.UI.RadAjaxPage
    {
        protected void Page_Load(object sender, EventArgs e)
        {
            if (Session["PerfectId"] == null)
                Response.Redirect("Login.aspx");
            Master.KeywordMaster.Attributes.Add("class", "start active open");
        }
        ...
        {
            AutoCompleteOMST webService = new AutoCompleteOMST();
            webService.ResetSearchCounterForHoldKeywords(false);
            ClientScript.RegisterStartupScript(Page.GetType(), "mykey", "MessageB();", true);
        }
    }
}