...
namespace AutoCompleteWebAdmin
{
    ...
    public partial class KeywordMasterForTesting : Telerik.Web.UI.RadAjaxPage
    {
        protected void Page_Load(object sender, EventArgs e)
        {
            if (Session["PerfectId"] == null)
                Response.Redirect("Login.aspx");
            Master.KeywordMasterTesting.Attributes.Add("class", "start active open");
        }
        ...
        protected void radGridKeyword_UpdateCommand(object sender, Telerik.Web.UI.GridCommandEventArgs e)
        {
            try
            {
                ...
                if (item != null)
                {
                    ...
                    var chkIsBing = item.FindControl("chkIsBing") as HtmlInputCheckBox;
                    ...
                    oCommand.Parameters.AddWithValue("IsTesting", false);
                    oCommand.Parameters.AddWithValue("IsBing", chkIsBing.Checked);

                    Int32 id = Convert.ToInt32(BaseDAO.GetExecuteScalar(oCommand, "UpdateKeywordDetails"));
                }
            }
            catch
            { }
        ...
        protected void radGridKeyword_DeleteCommand(object sender, Telerik.Web.UI.GridCommandEventArgs e)
        {
            try
            {
                ...
                if (item != null)
                {
                    ...
                    SqlCommand oCommand = new SqlCommand();
                    oCommand.Parameters.AddWithValue("Id", Id);
                    BaseDAO.GetExecuteScalar(oCommand, "DeleteKeyWordById");
                }
            }
            catch
            {
        ...
        protected void radGridKeyword_InsertCommand(object sender, Telerik.Web.UI.GridCommandEventArgs e)
        {
            try
            {
                ...
                if (item != null)
                {
                    ...
                    Int32 id = Convert.ToInt32(BaseDAO.GetExecuteScalar(oCommand, "InsertKeywordDetails"));
        ...
        protected void radGridKeyword_NeedDataSource(object sender, Telerik.Web.UI.GridNeedDataSourceEventArgs e)
        {
            SqlCommand oCommand = new SqlCommand();
            oCommand.Parameters.AddWithValue("IsTesting", false);
            radGridKeyword.DataSource = BaseDAO.GetDataDataset(oCommand, "GetAllKeyWords");
        }
            ...
            try
            {
                if (e.Item is GridEditableItem && e.Item.IsInEditMode)
                {
                    ...
                    if (item != null)
                    {
                        ...
                        SqlCommand oCommand = new SqlCommand();
                        oCommand.Parameters.AddWithValue("Id", Id);
                        DataSet ds = BaseDAO.GetDataDataset(oCommand, "GetKeyWordById");
                        var txtKeyword = item.FindControl("txtKeyword") as RadTextBox;
                        var txtLink = item.FindControl("txtLink") as RadTextBox;
                        var txtContact = item.FindControl("txtContact") as RadTextBox;
                        var txtOther = item.FindControl("txtOther") as RadTextBox;
                        ...
                        chkIsbing.Checked = Convert.ToBoolean(ds.Tables[0].Rows[0]["IsBing"]);
        ...
        protected void btnSubmit_Click(object sender, EventArgs e)
        {
            ...
            for (int i = 0; i < ds.Tables[0].Rows.Count; i++)
            {
                ...
                oCommand.Parameters.AddWithValue("IsTesting", false);
                oCommand.Parameters.AddWithValue("IsBing", ds.Tables[0].Rows[i]["IsBing"].ToString());
                Int32 id = Convert.ToInt32(BaseDAO.GetExecuteScalar(oCommand, "InsertKeywordDetails"));
            }
        ...
        {
            AutoCompleteOMST webService = new AutoCompleteOMST();
            webService.ResetSearchCounter(false);
        ...
        {
            AutoCompleteOMST webService = new AutoCompleteOMST();
            webService.ResetSearchCounterForHoldKeywords(true);
            ClientScript.RegisterStartupScript(Page.GetType(), "mykey", "MessageB();", true);
        }
    }
}